...
private:
	...
	std::map<std::string, std::vector<std::string>> makeMap()
	{
		return{
			...
			{ "decs_1", { "offset", "totalSize", "t" } },
			{ "decsLR1_1", { "offset", "totalSize", "t" } },
			{ "type_1", { "t", "width" } },
			{ "std_type_1", { "t", "width" } },
			...
			{ "subprgm_head_1", { "totalSize", "t" } },
			{ "subprgm_headLF1_1", { "totalSize", "t" } },
			{ "args_1", { "offset", "totalSize", "t" } },
			{ "param_list_1", { "offset", "totalSize", "t" } },
			{ "param_listLR1_1", { "offset", "totalSize", "t" } },
