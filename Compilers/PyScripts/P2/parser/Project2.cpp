...
void Project2::comp_stmtLF1() {
	...
	std::string exp = "id while call if begin end";
...
void Project2::opt_stmts() {
	...
	std::string exp = "if id while begin call";
...
void Project2::exprLF1() {
	...
	if(lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("then") || lookAhead.token == p->GTT("]") || lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT("else")) {
		return;
	}
	SynErrorTok(nt, exp);
}
...
void Project2::termLR1() {
	...
	std::string exp = "; end and , do > or + = <> * / <= then div ] ) else >= mod - <";
	...
	if(lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT(">") || lookAhead.token == p->GTT("or") || lookAhead.token == p->GTT("+") || lookAhead.token == p->GTT("=") || lookAhead.token == p->GTT("<>") || lookAhead.token == p->GTT("<=") || lookAhead.token == p->GTT("then") || lookAhead.token == p->GTT("]") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT("else") || lookAhead.token == p->GTT(">=") || lookAhead.token == p->GTT("-") || lookAhead.token == p->GTT("<")) {
		return;
	}
	SynErrorTok(nt, exp);
}
...
void Project2::simple_exprLR1() {
	...
	std::string exp = "; end , do > or + = <> <= then ] ) else >= - <";
	...
	if(lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT(">") || lookAhead.token == p->GTT("=") || lookAhead.token == p->GTT("<>") || lookAhead.token == p->GTT("<=") || lookAhead.token == p->GTT("then") || lookAhead.token == p->GTT("]") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT("else") || lookAhead.token == p->GTT(">=") || lookAhead.token == p->GTT("<")) {
		return;
	}
	SynErrorTok(nt, exp);
}
...
void Project2::factorLF1() {
	...
	std::string exp = "; and end , do > or + = <> * / <= div then ] ) else >= mod [ - <";
	...
	if(lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("and") || lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT(">") || lookAhead.token == p->GTT("or") || lookAhead.token == p->GTT("+") || lookAhead.token == p->GTT("=") || lookAhead.token == p->GTT("<>") || lookAhead.token == p->GTT("*") || lookAhead.token == p->GTT("/") || lookAhead.token == p->GTT("<=") || lookAhead.token == p->GTT("div") || lookAhead.token == p->GTT("then") || lookAhead.token == p->GTT("]") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT("else") || lookAhead.token == p->GTT(">=") || lookAhead.token == p->GTT("mod") || lookAhead.token == p->GTT("-") || lookAhead.token == p->GTT("<")) {
		return;
	}
	SynErrorTok(nt, exp);
}
