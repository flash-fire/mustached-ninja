...
void Project2::comp_stmtLF1(ParseNode* comp_stmtLF1_1) {
	...
	std::string exp = "if begin call while id end";
...
void Project2::opt_stmts(ParseNode* opt_stmts_1) {
	...
	std::string exp = "if id begin call while";
...
void Project2::exprLF1(ParseNode* exprLF1_1) {
	...
	std::string exp = "do , <> else then ) <= >= = end > ; ] <";
	...
	if (lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("else") || lookAhead.token == p->GTT("then") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("]")) {
...
void Project2::termLR1(ParseNode* termLR1_1) {
	...
	std::string exp = "do <> then ) + <= >= mod / > ; ] < * , else and div = or end -";
	...
	if (lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT("<>") || lookAhead.token == p->GTT("then") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT("+") || lookAhead.token == p->GTT("<=") || lookAhead.token == p->GTT(">=") || lookAhead.token == p->GTT(">") || lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("]") || lookAhead.token == p->GTT("<") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("else") || lookAhead.token == p->GTT("=") || lookAhead.token == p->GTT("or") || lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT("-")) {
...
void Project2::simple_exprLR1(ParseNode* simple_exprLR1_1) {
	...
	std::string exp = "do , <> else then ) + <= >= = or > end ; ] < -";
	...
	if (lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("<>") || lookAhead.token == p->GTT("else") || lookAhead.token == p->GTT("then") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT("<=") || lookAhead.token == p->GTT(">=") || lookAhead.token == p->GTT("=") || lookAhead.token == p->GTT(">") || lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("]") || lookAhead.token == p->GTT("<")) {
...
void Project2::factorLF1(ParseNode* factorLF1_1) {
	...
	if (lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT("<>") || lookAhead.token == p->GTT("then") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT("+") || lookAhead.token == p->GTT("<=") || lookAhead.token == p->GTT("/") || lookAhead.token == p->GTT("mod") || lookAhead.token == p->GTT(">=") || lookAhead.token == p->GTT(">") || lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("]") || lookAhead.token == p->GTT("*") || lookAhead.token == p->GTT("<") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("else") || lookAhead.token == p->GTT("and") || lookAhead.token == p->GTT("div") || lookAhead.token == p->GTT("=") || lookAhead.token == p->GTT("or") || lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT("-")) {
		int t_i = factorLF1_1->get("i");
