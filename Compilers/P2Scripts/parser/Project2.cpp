...
void Project2::comp_stmtLF1() {
	...
	std::string exp = "begin call if end id while";
...
void Project2::opt_stmts() {
	...
	std::string exp = "begin call if while id";
...
void Project2::exprLF1() {
	...
	if(lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT("else") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT("]") || lookAhead.token == p->GTT("then")) {
		return;
	}
	SynErrorTok(nt, exp);
}
...
void Project2::termLR1() {
	...
	std::string exp = "end - ) and > <> + , or ] = then ; / mod * else < <= do div >=";
	...
	if(lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT("-") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT(">") || lookAhead.token == p->GTT("<>") || lookAhead.token == p->GTT("+") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("or") || lookAhead.token == p->GTT("]") || lookAhead.token == p->GTT("=") || lookAhead.token == p->GTT("then") || lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("else") || lookAhead.token == p->GTT("<") || lookAhead.token == p->GTT("<=") || lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT(">=")) {
		return;
	}
	SynErrorTok(nt, exp);
}
...
void Project2::simple_exprLR1() {
	...
	std::string exp = "; end - ) > <> else < , + <= do or ] = >= then";
	...
	if(lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT(">") || lookAhead.token == p->GTT("<>") || lookAhead.token == p->GTT("else") || lookAhead.token == p->GTT("<") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("<=") || lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT("]") || lookAhead.token == p->GTT("=") || lookAhead.token == p->GTT(">=") || lookAhead.token == p->GTT("then")) {
		return;
	}
	SynErrorTok(nt, exp);
}
...
void Project2::factorLF1() {
	...
	if(lookAhead.token == p->GTT("end") || lookAhead.token == p->GTT("-") || lookAhead.token == p->GTT(")") || lookAhead.token == p->GTT("and") || lookAhead.token == p->GTT(">") || lookAhead.token == p->GTT("<>") || lookAhead.token == p->GTT("+") || lookAhead.token == p->GTT(",") || lookAhead.token == p->GTT("or") || lookAhead.token == p->GTT("]") || lookAhead.token == p->GTT("=") || lookAhead.token == p->GTT("then") || lookAhead.token == p->GTT(";") || lookAhead.token == p->GTT("/") || lookAhead.token == p->GTT("mod") || lookAhead.token == p->GTT("*") || lookAhead.token == p->GTT("else") || lookAhead.token == p->GTT("<") || lookAhead.token == p->GTT("<=") || lookAhead.token == p->GTT("do") || lookAhead.token == p->GTT("div") || lookAhead.token == p->GTT(">=")) {
		return;
	}
	SynErrorTok(nt, exp);
}
